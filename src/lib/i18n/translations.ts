...
const fr: Tr = {
  ...
  landing: {
    ...
    steps: [
      { icon: '📋', title: 'Tu décris ta situation', desc: 'Parcours, compétences, envies, contraintes. Quelques minutes suffisent.' },
      { icon: '📄', title: 'Tu ajoutes ton CV (optionnel)', desc: 'Pour affiner les résultats, OtherMe s\'appuie sur ton parcours réel.' },
      { icon: '🔍', title: 'OtherMe croise tout', desc: 'L\'IA analyse tes forces, tes envies et tes contraintes pour trouver les voies qui te correspondent.' },
      { icon: '🗺️', title: 'Tu découvres 3 autres vies possibles', desc: 'Rôle cible, Reality Score, compétences clés et plan d\'action 30 jours — pour chaque trajectoire.' },
    ],
  ...
  onb: {
    stepTitles: {
      ...
      3: { title: 'Ton énergie & tes domaines',          sub: "Ce qui t'anime, ce qui t'épuise et les domaines qui t'attirent" },
      4: { title: 'Ta direction & ta vision',            sub: "Tes envies actuelles, ta vision à 5 ans et le cadre qui te correspond" },
      5: { title: 'Ton environnement & tes priorités',   sub: "Où tu veux travailler, ton rôle idéal et tes priorités" },
      6: { title: 'Tes contraintes & ton chemin',        sub: "Ton temps disponible, ce que tu veux éviter et ton parcours perçu" },
      7: { title: 'Ta vision du succès & ton profil',    sub: "Ce qui ferait une transition réussie et ton profil dominant" },
      8: { title: 'Questions adaptées à ton profil',     sub: 'Quelques questions personnalisées selon tes réponses' },
    },
...
const en: Tr = {
  ...
  landing: {
    ...
    steps: [
      { icon: '📋', title: 'You describe your situation', desc: 'Background, skills, goals, constraints. A few minutes is all it takes.' },
      { icon: '📄', title: 'You add your CV (optional)', desc: 'To refine results, OtherMe uses your real background to sharpen the paths.' },
      { icon: '🔍', title: 'OtherMe connects the dots', desc: 'The AI analyses your strengths, desires and constraints to find paths that truly match you.' },
      { icon: '🗺️', title: 'You discover 3 other possible lives', desc: 'Target role, Reality Score, key skills and 30-day action plan — for each path.' },
    ],
  ...
  onb: {
    stepTitles: {
      ...
      3: { title: 'Your energy & domains',               sub: 'What drives you, what drains you, and the areas that attract you' },
      4: { title: 'Your direction & vision',             sub: 'Your current goals, your 5-year vision, and the lifestyle that suits you' },
      5: { title: 'Your environment & priorities',       sub: 'Where you want to work, your ideal role, and your priorities' },
      6: { title: 'Your constraints & path',             sub: 'Your available time, what to avoid, and your perceived path' },
      7: { title: 'Your success criteria & profile',     sub: 'What a successful transition looks like for you and your dominant profile' },
      8: { title: 'Questions tailored to you',           sub: 'A few personalized questions based on your answers' },
    },
