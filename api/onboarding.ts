  ...
  "paths": [
    {
      ...
      "companyTypesToTarget": [
        "Type d'entreprise 1 — terrain d'entrée adapté pour ${firstName} + critères à vérifier",
        ...
        "Type d'entreprise 4 — opportunité spécifique au secteur"
      ],
      "questionsToAskProfessionals": [
        "Question 1 sur la réalité du quotidien — pourquoi utile pour valider cette trajectoire",
        ...
        "Question 5 sur ce qui différencie les profils qui réussissent"
      ],
      "choosePath": [
        "Si tu veux [aspect concret de ce métier] — lien avec les réponses de ${firstName}",
        "Si ta priorité est [valeur ou besoin déclaré]",
    ...
    },
    {
      ...
      "questionsToAskProfessionals": [
        ...
        "Question 2 sur les conditions d'entrée pour un profil en reconversion",
      ...
      "choosePath": [
        "Si l'alignement avec tes valeurs prime sur la rapidité de transition",
        "Si tu es prêt à accepter [contrainte spécifique de cette trajectoire passion]",
        "Si [élément déclaré par ${firstName}] est un moteur de décision fort"
      ],
      "avoidPath": [
    ...
    },
    {
      ...
      "questionsToAskProfessionals": [
        ...
        "Question 2 sur les conditions à réunir avant de se lancer",
      ...
      "choosePath": [
        ...
        "Si [force spécifique de ${firstName}] est un avantage différenciateur dans ce secteur"
      ],
      "avoidPath": [
